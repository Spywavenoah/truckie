...
export default function ClientSettingsPage() {
  ...
  useEffect(() => {
    fetch("/api/users/me")
      ...
      .catch((e) => console.error("client settings: fetch failed", e));
  }, []);
        ...
        <CardContent>
          <form onSubmit={saveProfile} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="client-name" className="block text-sm font-medium text-neutral-700">Full Name</label>
                <input
                  id="client-name"
                  type="text"
              ...
              <div>
                <label htmlFor="client-email" className="block text-sm font-medium text-neutral-700">Email</label>
                <input
                  id="client-email"
                  type="email"
                  value={profile.email}
            ...
            <div className="flex items-end gap-3">
              <div className="flex-1">
                <label htmlFor="client-phone" className="block text-sm font-medium text-neutral-700">Phone</label>
                <input
                  id="client-phone"
                  type="tel"
                  value={profile.phone}
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={changePassword} className="space-y-4">
            <div>
              <label htmlFor="client-current-pass" className="block text-sm font-medium text-neutral-700">Current Password</label>
              <input
                id="client-current-pass"
                type="password"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="client-new-pass" className="block text-sm font-medium text-neutral-700">New Password</label>
                <input
                  id="client-new-pass"
                  type="password"
              ...
              <div>
                <label htmlFor="client-confirm-pass" className="block text-sm font-medium text-neutral-700">Confirm Password</label>
                <input
                  id="client-confirm-pass"
                  type="password"
