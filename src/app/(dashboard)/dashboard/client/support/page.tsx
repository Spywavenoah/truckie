...
export default function ClientSupportPage() {
  ...
  useEffect(() => {
    fetch("/api/support")
      ...
      .catch((e) => console.error("client support: fetch failed", e))
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/dashboard/client/support/new"><Button>New Ticket</Button></Link>
      </div>
                ...
                <tbody className="divide-y divide-neutral-200">
                  {tickets.map((t) => (
                    <tr key={t.id} className="hover:bg-neutral-50">
                      ...
                      <td className="px-3 py-2 md:px-4 md:py-3">
                        <Link href={`/dashboard/client/support/${t.id}`}><Button variant="outline" size="sm">View</Button></Link>
                      </td>
                    </tr>
                  ))}
                </tbody>
