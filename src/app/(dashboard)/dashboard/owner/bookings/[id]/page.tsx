    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-neutral-900">{booking.client.fullName}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-neutral-500">Email</span>
              <span className="text-neutral-900">{booking.client.email}</span>
            </div>
            {booking.client.phone && (
              <div className="flex justify-between text-sm">
                <span className="text-neutral-500">Phone</span>
                <span className="text-neutral-900">{booking.client.phone}</span>
              </div>
            )}
          </CardContent>
        </Card>
      ...
      {booking.clientNote && (
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-neutral-700">{booking.clientNote}</p>
          </CardContent>
        </Card>
      )}
        ...
        <CardContent>
          <div className="flex flex-wrap gap-3">
            {booking.status === "PENDING" && (
              <>
                <Button onClick={() => updateStatus("ACCEPTED")} disabled={actionLoading}>
                  Accept Booking
                </Button>
                <Button variant="destructive" onClick={() => updateStatus("REJECTED")} disabled={actionLoading}>
                  Reject Booking
                </Button>
              </>
            )}
